...
def censusMap (geoDataFilePath, dataSource, rowCompare, title, rowArrayBar, mapZoomSettings, fileName=None, htmlName = None):
    ...
    Parameters:
        ...
        mapZoomSettings - specific settings for map zooming (array). Should be set up in form
            ...
            ---
            Use [9, 43.710, -79.380, 2000, 1250] for City of Toronto-wide maps
            Use [9.8, 43.810, -79.245, 2000, 1250] for Ward 23 maps
    ...
    fig.update_layout(
        ...
        title={"text": title, "x": 0.5, "xanchor": "center", "yanchor": "top", "font": {"size": 15}},
        legend=dict(
            x=0.5,               
            y=0.1,               
            xanchor="center",  
...
censusMap("data/Neighbourhoods.geojson", "data/CityCensusData.csv", 2577, "Amount of Census 2021 respondents who listed driving as a method of transportation", "Respondents", [9, 43.710, -79.380, 2000, 1250], "./pdf/CensusDrivingDataTorontoWide.pdf", "census_driving_toronto")
censusMap("data/Neighbourhoods.geojson", "data/CityCensusData.csv", 2580, "Amount of Census 2021 respondents who listed public transportation as a method of transportation", "Respondents", [9, 43.710, -79.380, 2000, 1250], "./pdf/CensusPublicTransportDataTorontoWide.pdf", "census_pt_toronto")
censusMap("data/Neighbourhoods.geojson", "data/CityCensusData.csv", 2581, "Amount of Census 2021 respondents who listed walking as a method of transportation", "Respondents", [9, 43.710, -79.380, 2000, 1250], "./pdf/CensusWalkingDataTorontoWide.pdf", "census_walking_toronto")
censusMap("data/Neighbourhoods.geojson", "data/CityCensusData.csv", 2582, "Amount of Census 2021 respondents who listed biking as a method of transportation", "Respondents", [9, 43.710, -79.380, 2000, 1250], "./pdf/CensusBikingDataTorontoWide.pdf", "census_biking_toronto")

# Ward 23 Localized Census Maps
censusMap("data/Ward23Neighbourhoods.geojson", "data/Ward23CensusData.csv", 2577, "Amount of Census 2021 respondents who listed driving as a method of transportation", "Respondents", [9.8, 43.810, -79.245, 2000, 1250], "./pdf/CensusDrivingDataWard23.pdf", "census_driving_ward23")
censusMap("data/Ward23Neighbourhoods.geojson", "data/Ward23CensusData.csv", 2580, "Amount of Census 2021 respondents who listed public transportation as a method of transportation", "Respondents", [9.8, 43.810, -79.245, 2000, 1250], "./pdf/CensusPublicTransportDataWard23.pdf", "census_pt_ward23")
censusMap("data/Ward23Neighbourhoods.geojson", "data/Ward23CensusData.csv", 2581, "Amount of Census 2021 respondents who listed walking as a method of transportation", "Respondents", [9.8, 43.810, -79.245, 2000, 1250], "./pdf/CensusWalkingDataWard23.pdf", "census_walking_ward23")
censusMap("data/Ward23Neighbourhoods.geojson", "data/Ward23CensusData.csv", 2582, "Amount of Census 2021 respondents who listed biking as a method of transportation", "Respondents", [9.8, 43.810, -79.245, 2000, 1250], "./pdf/CensusBikingDataWard23.pdf", "census_biking_ward23")
...
pointMap(["data/PublicTransportDestinations-AgincourtNorth.geojson", "data/PublicTransportDestinations-MalvernEast.geojson", "data/PublicTransportDestinations-MalvernWest.geojson", "data/PublicTransportDestinations-Milliken.geojson", "data/PublicTransportDestinations-Morningside.geojson"], ["red", "blue", "purple", "green", "black"], ["Agincourt North", "Malvern East", "Malvern West", "Milliken", "Morningside Heights"], "Ward 23 survey respondents regarding public transit destinations", [9, 43.650, -79.400, 2000, 1250], "./pdf/Ward23PublicTransportDestinations.pdf", "survey_pt_destinations")
pointMap(["data/BikingDestinations-AgincourtNorth.geojson", "data/BikingDestinations-MalvernEast.geojson", "data/BikingDestinations-MalvernWest.geojson", "data/BikingDestinations-Milliken.geojson", "data/BikingDestinations-Morningside.geojson"], ["red", "blue", "purple", "green", "black"], ["Agincourt North", "Malvern East", "Malvern West", "Milliken", "Morningside Heights"], "Ward 23 survey respondents regarding biking destinations", [9, 43.700, -79.300, 2000, 1250], "./pdf/Ward23BikingDestinations.pdf", "survey_biking_destinations")

# Bike Share Station Recommendations
pointMap(["data/BikeShare-AgincourtNorth.geojson", "data/BikeShare-AgincourtSouthMalvernWest.geojson", "data/BikeShare-MalvernEast.geojson", "data/BikeShare-MalvernWest.geojson", "data/BikeShare-Milliken.geojson", "data/BikeShare-Morningside.geojson"], ["red", "gray", "blue", "purple", "green", "black"], ["Agincourt North", "Agincourt South-Malvern West", "Malvern East", "Malvern West", "Milliken", "Morningside Heights"], "Ward 23 survey respondents regarding future Bike Share Toronto stations", [9, 43.650, -79.400, 2000, 1250], "./pdf/Ward23BikeShare.pdf", "survey_bikeshare_stations")
...
pointMap(["data/DrivingDestinations-AgincourtNorth.geojson", "data/DrivingDestinations-MalvernEast.geojson", "data/DrivingDestinations-MalvernWest.geojson", "data/DrivingDestinations-Milliken.geojson", "data/DrivingDestinations-Morningside.geojson"], ["red", "blue", "purple", "green", "black"], ["Agincourt North", "Malvern East", "Malvern West", "Milliken", "Morningside Heights"], "Ward 23 survey respondents regarding driving destinations", [9.25, 43.800, -79.300, 2000, 1250], "./pdf/Ward23DrivingDestinationsScarboroughFocused.pdf", "survey_driving_destinations_scarborough")
pointMap(["data/BikeShare-AgincourtNorth.geojson", "data/BikeShare-AgincourtSouthMalvernWest.geojson", "data/BikeShare-MalvernEast.geojson", "data/BikeShare-MalvernWest.geojson", "data/BikeShare-Milliken.geojson", "data/BikeShare-Morningside.geojson"], ["red", "gray", "blue", "purple", "green", "black"], ["Agincourt North", "Agincourt South-Malvern West", "Malvern East", "Malvern West", "Milliken", "Morningside Heights"], "Ward 23 survey respondents regarding future Bike Share Toronto stations", [9.2, 43.795, -79.300, 2000, 1250], "./pdf/Ward23BikeShareScarboroughFocused.pdf", "survey_bikeshare_stations_scarborough")